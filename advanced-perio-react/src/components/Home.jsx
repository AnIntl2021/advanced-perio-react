          ...
          <div className="hero__content">
            ...
            <div className="hero__card fade-up-2">
              <p className="hero__card-title">
                <i className="fas fa-calendar-alt" style={{ marginRight: '.5rem', color: 'var(--gold)' }}></i>
              ...
              <form onSubmit={e => e.preventDefault()}>
                ...
                <select>
                  ...
                  <option>Gum Disease Treatment</option>
          ...
          <div className="about-split">
            ...
            <div className="about-split__text">
              ...
              <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                ...
                <a href="tel:2103325335" className="btn btn-outline">
